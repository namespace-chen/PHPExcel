...
class ColumnIterator implements \Iterator
{
   ...
   public function resetStart($startColumn = 'A')
   {
      ...
      if ($startColumnIndex > \PHPExcel\Cell::columnIndexFromString($this->subject->getHighestColumn()) - 1) {
         throw new \PHPExcel\Exception("Start column ({$startColumn}) is beyond highest column ({$this->subject->getHighestColumn()})");
      }
    ...
    *
    * @return \PHPExcel\Worksheet\Column
    */
   public function current()
   {
      return new \PHPExcel\Worksheet\Column($this->subject, \PHPExcel\Cell::stringFromColumnIndex($this->position));
   }
