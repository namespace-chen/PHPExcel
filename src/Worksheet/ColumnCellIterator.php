 ...
 */
class ColumnCellIterator extends \PHPExcel\Worksheet\CellIterator implements \Iterator
{
   /**
    * Column index
    *
    ...
    *
    * @param integer    $startRow    The row number at which to start iterating
    * @return \PHPExcel\Worksheet\ColumnCellIterator
