...
class Column
{
    ...
    *
    * @var array of \PHPExcel\Worksheet\AutoFilter\Column\Rule
    */
   ...
   /**
    * Create a new \PHPExcel\Worksheet\AutoFilter\Column
    *
    ...
    *
    * @throws    \PHPExcel\Exception
    * @return array of \PHPExcel\Worksheet\AutoFilter\Column\Rule
    */
    ...
    * @return    \PHPExcel\Worksheet\AutoFilter\Column\Rule
    */
   public function getRule($pIndex)
   {
      if (!isset($this->ruleset[$pIndex])) {
         $this->ruleset[$pIndex] = new \PHPExcel\Worksheet\AutoFilter\Column\Rule($this);
      }
   ...
   {
      $this->ruleset[] = new \PHPExcel\Worksheet\AutoFilter\Column\Rule($this);
    ...
    *
    * @param    \PHPExcel\Worksheet\AutoFilter\Column\Rule    $pRule
    * @param    boolean    $returnRule     Flag indicating whether the rule object or the column object should be returned
    * @return    \PHPExcel\Worksheet\AutoFilter\Column|\PHPExcel\Worksheet\AutoFilter\Column\Rule
    */
   public function addRule(\PHPExcel\Worksheet\AutoFilter\Column\Rule $pRule, $returnRule = true)
   {
