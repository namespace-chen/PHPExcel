...
/**
 * \PHPExcel\Worksheet\BaseDrawing
 *
...
class BaseDrawing implements \PHPExcel\IComparable
{
    ...
    * Shadow
    *
    * @var \PHPExcel\Worksheet\Drawing\Shadow
    */
   protected $shadow;

   /**
    * Create a new \PHPExcel\Worksheet\BaseDrawing
    */
   public function __construct()
   {
      ...
      $this->rotation           = 0;
      $this->shadow             = new \PHPExcel\Worksheet\Drawing\Shadow();
    ...
    * Set Shadow
    *
    * @param     \PHPExcel\Worksheet\Drawing\Shadow $pValue
    * @throws     \PHPExcel\Exception
    * @return \PHPExcel\Worksheet\BaseDrawing
    */
   public function setShadow(\PHPExcel\Worksheet\Drawing\Shadow $pValue = null)
   {
      $this->shadow = $pValue;
      return $this;
   }
