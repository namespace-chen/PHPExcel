...
class PageSetup
{
    ...
    * @var int
    */
   private $paperSize = \PHPExcel\Worksheet\PageSetup::PAPERSIZE_LETTER;
    ...
    * @var string
    */
   private $orientation = \PHPExcel\Worksheet\PageSetup::ORIENTATION_DEFAULT;
   ...
   /**
    * Create a new \PHPExcel\Worksheet\PageSetup
    */
