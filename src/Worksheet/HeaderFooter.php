...
/**
 * \PHPExcel\Worksheet\HeaderFooter
 *
...
class HeaderFooter
{
    ...
    *
    * @var \PHPExcel\Worksheet\HeaderFooterDrawing[]
    */
   private $headerFooterImages = array();

   /**
    * Create a new \PHPExcel\Worksheet\HeaderFooter
    */
    ...
    *
    * @param \PHPExcel\Worksheet\HeaderFooterDrawing $image
    * @param string $location
    * @throws \PHPExcel\Exception
    * @return \PHPExcel\Worksheet\HeaderFooter
    */
   public function addImage(\PHPExcel\Worksheet\HeaderFooterDrawing $image = null, $location = self::IMAGE_HEADER_LEFT)
   {
    ...
    *
    * @param \PHPExcel\Worksheet\HeaderFooterDrawing[] $images
    * @throws \PHPExcel\Exception
    * @return \PHPExcel\Worksheet\HeaderFooter
    */
    ...
    *
    * @return \PHPExcel\Worksheet\HeaderFooterDrawing[]
    */
