 ...
 */
class Run extends \PHPExcel\RichText\TextElement implements \PHPExcel\RichText\ITextElement
{
   /**
    * Font
    *
   ...
   /**
    * Create a new \PHPExcel\RichText\Run instance
    *
