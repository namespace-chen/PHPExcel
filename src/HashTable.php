...
class HashTable
{
   ...
   public function addFromSource($pSource = null)
   {
      ...
      if ($pSource == null) {
         ...
         throw new \PHPExcel\Exception('Invalid array parameter passed.');
      }
    ...
    * @throws    \PHPExcel\Exception
    */
   public function add(\PHPExcel\IComparable $pSource = null)
   {
    ...
    * @throws    \PHPExcel\Exception
    */
   public function remove(\PHPExcel\IComparable $pSource = null)
   {
      $hash = $pSource->getHashCode();
      if (isset($this->items[$hash])) {
