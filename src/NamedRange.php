...
class NamedRange
{
    ...
    */
   public function __construct($pName = null, \PHPExcel\Worksheet $pWorksheet, $pRange = 'A1', $pLocalOnly = false, $pScope = null)
   {
      // Validate data
      if (($pName === null) || ($pWorksheet === null) || ($pRange === null)) {
         throw new \PHPExcel\Exception('Parameters can not be null.');
      }
   ...
   public function setName($value = null)
   {
      if ($value !== null) {
         ...
         // New title
         $newTitle = $this->name;
         \PHPExcel\ReferenceHelper::getInstance()->updateNamedFormulas($this->worksheet->getParent(), $oldTitle, $newTitle);
      }
      return $this;
   }
    ...
    * Set worksheet
    *
    * @param \PHPExcel\Worksheet $value
    * @return \PHPExcel\NamedRange
    */
   public function setWorksheet(\PHPExcel\Worksheet $value = null)
   {
      if ($value !== null) {
    ...
    * Set scope
    *
    * @param \PHPExcel\Worksheet|null $value
    * @return \PHPExcel\NamedRange
    */
   public function setScope(\PHPExcel\Worksheet $value = null)
   {
      $this->scope = $value;
    ...
    * @return \PHPExcel\NamedRange
    */
   public static function resolveRange($pNamedRange = '', \PHPExcel\Worksheet $pSheet)
   {
