...
class IOFactory
{
   ...
   public static function setSearchLocations($value)
   {
      if (is_array($value)) {
         ...
         throw new \PHPExcel\Reader\Exception('Invalid parameter passed.');
      }
   }
    ...
    * @param    string $classname     Example: \PHPExcel\Writer\{0}
    */
    ...
    * @static
    * @access    public
    * @param    \PHPExcel\PHPExcel $phpExcel
    * @param    string  $writerType    Example: Excel2007
    * @return    \PHPExcel\Writer\IWriter
    * @throws    \PHPExcel\Reader\Exception
    */
   public static function createWriter(\PHPExcel\PHPExcel $phpExcel, $writerType = '')
   {
      // Search type
      $searchType = 'IWriter';
      ...
      // Nothing found...
      throw new \PHPExcel\Reader\Exception("No $searchType found for type $writerType");
   }
    ...
    * @return    \PHPExcel\Reader\IReader
    * @throws    \PHPExcel\Reader\Exception
    */
   public static function createReader($readerType = '')
   {
      ...
      // Nothing found...
      throw new \PHPExcel\Reader\Exception("No $searchType found for type $readerType");
   }

   /**
    * Loads PHPExcel from file using automatic \PHPExcel\Reader\IReader resolution
    *
    * @static
    * @access public
   ...
   /**
    * Identify file type using automatic \PHPExcel\Reader\IReader resolution
    *
    * @static
    * @access public
   ...
   {
      $reader = self::createReaderForFile($pFilename);
      $classType = explode('\\', get_class($reader));
      unset($reader);
   ...
   public static function createReaderForFile($pFilename)
   {
      ...
      throw new \PHPExcel\Reader\Exception('Unable to identify a reader for this file');
   }
}
