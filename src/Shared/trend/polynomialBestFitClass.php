...
/**
 * \PHPExcel\Shared\trend\polynomialBestFitClass
 *
 ...
 */
class polynomialBestFitClass extends \PHPExcel\Shared\trend\bestFitClass
{
   /**
   ...
   private function polynomialRegression($order, $yValues, $xValues, $const)
   {
      ...
      $matrixA = new \PHPExcel\Shared\JAMA\Matrix($A);
      $matrixB = new \PHPExcel\Shared\JAMA\Matrix($B);
