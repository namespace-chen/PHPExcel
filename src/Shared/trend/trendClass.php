...
class trendClass
{
    ...
    *
    * @var \PHPExcel\Shared\trend\bestFitClass[]
    **/
      ...
      switch ($trendType) {
         ...
         case self::TREND_POWER:
            if (!isset(self::$trendCache[$key])) {
               $className = "\\PHPExcel\\{$trendType}\\BestFitClass";
         ...
         case self::TREND_POLYNOMIAL_6:
            if (!isset(self::$trendCache[$key])) {
               ...
               self::$trendCache[$key] = new \PHPExcel\Shared\trend\polynomialBestFitClass($order, $yValues, $xValues, $const);
            }
            return self::$trendCache[$key];
         ...
         case self::TREND_BEST_FIT_NO_POLY:
            ...
            foreach (self::$trendTypes as $trendMethod) {
               $className = "\\PHPExcel\\{$trendMethod}\\BestFitClass";
            ...
            if ($trendType != self::TREND_BEST_FIT_NO_POLY) {
               foreach (self::$trendTypePolynomialOrders as $trendMethod) {
                  ...
                  $bestFit[$trendMethod] = new \PHPExcel\Shared\trend\polynomialBestFitClass($order, $yValues, $xValues, $const);
