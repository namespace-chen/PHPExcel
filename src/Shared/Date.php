...
class Date
{
   ...
   public static function ExcelToPHP($dateValue = 0, $adjustToTimezone = false, $timezone = null)
   {
      ...
      $timezoneAdjustment = ($adjustToTimezone) ?
         \PHPExcel\Shared\TimeZone::getTimezoneAdjustment($timezone, $returnValue) :
         0;
   ...
   public static function PHPToExcel($dateValue = 0, $adjustToTimezone = false, $timezone = null)
   {
      ...
      $timezoneAdjustment = ($adjustToTimezone) ?
         \PHPExcel\Shared\TimeZone::getTimezoneAdjustment($timezone ? $timezone : $saveTimeZone, $dateValue) :
         0;
   ...
   public static function stringToExcel($dateValue = '')
   {
      ...
      if ($dateValueNew === \PHPExcel\Calculation\Funcs::VALUE()) {
         return false;
      }
