...
class Font
{
   ...
   public static function calculateColumnWidth(\PHPExcel\Style\Font $font, $cellText = '', $rotation = 0, \PHPExcel\Style\Font $defaultFont = null)
   {
      ...
      $columnWidth = \PHPExcel\Shared\Drawing::pixelsToCellDimension($columnWidth, $defaultFont);
   ...
   public static function getTextWidthPixelsApprox($columnText, \PHPExcel\Style\Font $font = null, $rotation = 0)
   {
      ...
      switch ($fontName) {
         case 'Calibri':
            ...
            $columnWidth = (int) (8.26 * \PHPExcel\Shared\String::CountCharacters($columnText));
            $columnWidth = $columnWidth * $fontSize / 11; // extrapolate from font size
            break;

         case 'Arial':
            // value 7 was found via interpolation by inspecting real Excel files with Arial 10 font.
            //                $columnWidth = (int) (7 * \PHPExcel\Shared\String::CountCharacters($columnText));
            // value 8 was set because of experience in different exports at Arial 10 font.
            $columnWidth = (int) (8 * \PHPExcel\Shared\String::CountCharacters($columnText));
