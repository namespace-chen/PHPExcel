...
class OLE
{
   ...
   public function getStream($blockIdOrPps)
   {
      ...
      if ($blockIdOrPps instanceof \PHPExcel\Shared\OLE\PPS) {
      ...
      for ($pos = 0;; $pos += 128) {
         ...
         switch ($type) {
            case self::OLE_PPS_TYPE_ROOT:
               $pps = new \PHPExcel\Shared\OLE\PPS\Root(null, null, array());
               $this->root = $pps;
               break;
            case self::OLE_PPS_TYPE_DIR:
               $pps = new \PHPExcel\Shared\OLE\PPS(null, null, null, null, null, null, null, null, null, array());
               break;
            case self::OLE_PPS_TYPE_FILE:
               $pps = new \PHPExcel\Shared\OLE\PPS\File($name);
               break;
            default:
               continue;
         }
