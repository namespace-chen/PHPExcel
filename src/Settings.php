...
class Settings
{
   ...
   {
      return \PHPExcel\CachedObjectStorageFactory::getCacheStorageMethod();
   }
   ...
   {
      return \PHPExcel\CachedObjectStorageFactory::getCacheStorageClass();
   }
    ...
    * @return boolean Success or failure
    */
   public static function setCacheStorageMethod($method = \PHPExcel\CachedObjectStorageFactory::cache_in_memory, $arguments = array())
   {
      return \PHPExcel\CachedObjectStorageFactory::initialize($method, $arguments);
   }
   ...
   {
      return \PHPExcel\Calculation::getInstance()->setLocale($locale);
   }
