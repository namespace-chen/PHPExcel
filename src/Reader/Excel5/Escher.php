...
class Escher
{
   ...
   /**
    * Create a new \PHPExcel\Reader\Excel5\Escher instance
    *
    * @param mixed $object
    */
   ...
   private function readDggContainer()
   {
      ...
      $reader = new \PHPExcel\Reader\Excel5\Escher($dggContainer);
   ...
   private function readBstoreContainer()
   {
      ...
      $reader = new \PHPExcel\Reader\Excel5\Escher($bstoreContainer);
      $reader->load($recordData);
   }
   ...
   private function readSpgrContainer()
   {
      ...
      if ($this->object instanceof \PHPExce\Shared\Escher\DgContainer) {
         // DgContainer
      ...
      $reader = new \PHPExcel\Reader\Excel5\Escher($spgrContainer);
      $escher = $reader->load($recordData);
   }
   ...
   private function readSpContainer()
   {
      ...
      // record is a container, read contents
      $reader = new \PHPExcel\Reader\Excel5\Escher($spContainer);
      $escher = $reader->load($recordData);
   }
