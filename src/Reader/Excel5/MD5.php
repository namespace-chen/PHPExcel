...
class MD5
{
   ...
   public function add($data)
   {
      ...
      $F = array('\PHPExcel\Reader\Excel5\MD5', 'f');
      $G = array('\PHPExcel\Reader\Excel5\MD5', 'g');
      $H = array('\PHPExcel\Reader\Excel5\MD5', 'h');
      $I = array('\PHPExcel\Reader\Excel5\MD5', 'i');
