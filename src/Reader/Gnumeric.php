 ...
 */
class Gnumeric extends \PHPExcel\Reader\Abs implements \PHPExcel\Reader\IReader
{
   /**
    * Formats
    *
   ...
   /**
    * Create a new \PHPExcel\Reader\Gnumeric
    */
   ...
   public function canRead($pFilename)
   {
      ...
      if (!function_exists('gzread')) {
         throw new \PHPExcel\Reader\Exception("gzlib library is not enabled");
      }
