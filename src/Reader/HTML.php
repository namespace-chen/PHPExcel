...
class HTML extends \PHPExcel\Reader\Abs implements \PHPExcel\Reader\IReader
{
   ...
   /**
    * Create a new \PHPExcel\Reader\HTML
    */
   ...
   public function loadIntoExisting($pFilename, \PHPExcel\PHPExcel $objPHPExcel)
   {
      ...
      if (!$this->isValidFormat()) {
         ...
         throw new \PHPExcel\Reader\Exception($pFilename . " is an Invalid HTML file.");
      }
      ...
      if ($loaded === false) {
         throw new \PHPExcel\Reader\Exception('Failed to load ' . $pFilename . ' as a DOM Document');
      }
   ...
   public function securityScan($xml)
   {
      ...
      if (preg_match($pattern, $xml)) {
         throw new \PHPExcel\Reader\Exception('Detected use of ENTITY in XML, spreadsheet file load() aborted to prevent XXE/XEE attacks');
      }
      return $xml;
   }
}
