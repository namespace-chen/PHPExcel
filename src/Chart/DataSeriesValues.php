...
class DataSeriesValues
{
   ...
   /**
    * Create a new \PHPExcel\Chart\DataSeriesValues object
    */
    ...
    * @return    \PHPExcel\Chart\DataSeriesValues
    */
   public function setDataType($dataType = self::DATASERIES_TYPE_NUMBER)
   {
      if (!in_array($dataType, self::$dataTypeValues)) {
         throw new \PHPExcel\Chart\Exception('Invalid datatype for chart data series values');
      }
   ...
   {
      $this->dataValues = \PHPExcel\Calculation\Funcs::flattenArray($dataValues);
   ...
   public function refresh(\PHPExcel\Worksheet $worksheet, $flatten = true)
   {
      if ($this->dataSource !== null) {
         ...
         if ($flatten) {
            $this->dataValues = \PHPExcel\Calculation\Funcs::flattenArray($newDataValues);
