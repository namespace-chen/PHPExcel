 ...
 */
class Excel2007 extends \PHPExcel\Writer\Abs implements \PHPExcel\Writer\IWriter
{
   /**
    ...
    *
    * @var \PHPExcel\Writer\Excel2007\WriterPart[]
    */
   ...
   /**
    * Create a new \PHPExcel\Writer\Excel2007
    *
