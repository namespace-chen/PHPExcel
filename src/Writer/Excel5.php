 ...
 */
class Excel5 extends \PHPExcel\Writer\Abs implements \PHPExcel\Writer\IWriter
{
   /**
    * PHPExcel object
    *
   ...
   /**
    * Create a new \PHPExcel\Writer\Excel5
    *
   ...
   public function __construct(\PHPExcel\PHPExcel $phpExcel)
   {
      ...
      $this->parser        = new \PHPExcel\Writer\Excel5\Parser();
   }
   ...
   public function save($pFilename = null)
   {
      ...
      $saveDateReturnType = \PHPExcel\Calculation\Funcs::getReturnDateType();
      ...
      $this->writerWorkbook = new \PHPExcel\Writer\Excel5\Workbook($this->phpExcel, $this->strTotal, $this->strUnique, $this->strTable, $this->colors, $this->parser);

      // Initialise worksheet writers
      $countSheets = $this->phpExcel->getSheetCount();
      for ($i = 0; $i < $countSheets; ++$i) {
         $this->writerWorksheets[$i] = new \PHPExcel\Writer\Excel5\Worksheet($this->strTotal, $this->strUnique, $this->strTable, $this->colors, $this->parser, $this->preCalculateFormulas, $this->phpExcel->getSheet($i));
      }
      ...
      \PHPExcel\Calculation\Funcs::setReturnDateType($saveDateReturnType);
   ...
   private function buildWorksheetEschers()
   {
      ...
      foreach ($this->phpExcel->getAllsheets() as $sheet) {
         ...
         // dgContainer
         $dgContainer = new \PHPExce\Shared\Escher\DgContainer();
         ...
         // spgrContainer
         $spgrContainer = new \PHPExce\Shared\Escher\DgContainer\SpgrContainer();
         $dgContainer->setSpgrContainer($spgrContainer);

         // add one shape which is the group shape
         $spContainer = new \PHPExce\Shared\Escher\DgContainer\SpgrContainer\SpContainer();
   ...
   private function buildWorkbookEscher()
   {
      ...
      // dggContainer
      $dggContainer = new \PHPExce\Shared\Escher\DggContainer();
