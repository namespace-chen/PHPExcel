...
/**
 * \PHPExcel\Writer\OpenDocument\MetaInf
 *
 ...
 */
class MetaInf extends \PHPExcel\Writer\OpenDocument\WriterPart
{
   /**
    ...
    */
   public function writeManifest(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
      if (!$pPHPExcel) {
