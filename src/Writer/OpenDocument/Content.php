...
/**
 * \PHPExcel\Writer\OpenDocument\Content
 *
 * @category   PHPExcel
 * @package    \PHPExcel\Writer\OpenDocument
 * @copyright  Copyright (c) 2006 - 2015 PHPExcel (http://www.codeplex.com/PHPExcel)
 ...
 */
class Content extends \PHPExcel\Writer\OpenDocument\WriterPart
{
    ...
    */
   public function write(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
      if (!$pPHPExcel) {
    ...
    */
   private function writeSheets(\PHPExcel\Shared\XMLWriter $objWriter)
   {
      $pPHPExcel = $this->getParentWriter()->getPHPExcel(); /* @var $pPHPExcel PHPExcel */
    ...
    */
   private function writeRows(\PHPExcel\Shared\XMLWriter $objWriter, \PHPExcel\Worksheet $sheet)
   {
    ...
    * @throws \PHPExcel\Writer\Exception
    */
   private function writeCells(\PHPExcel\Shared\XMLWriter $objWriter, \PHPExcel\Worksheet\Row $row)
   {
      ...
      while ($cells->valid()) {
         ...
         \PHPExcel\Writer\OpenDocument\Cell\Comment::write($objWriter, $cell);
         $objWriter->endElement();
         $prev_column = $column;
         $cells->next();
      }
    ...
    */
   private function writeCellSpan(\PHPExcel\Shared\XMLWriter $objWriter, $curColumn, $prevColumn)
   {
