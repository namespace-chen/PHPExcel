...
abstract class Core extends \PHPExcel\Writer\HTML
{
   ...
   /**
    *  Create a new \PHPExcel\Writer\PDF
    *
   ...
   public function __construct(\PHPExcel\PHPExcel $phpExcel)
   {
      ...
      $this->tempDir = \PHPExcel\Shared\File::sys_get_temp_dir();
   }
   ...
   protected function prepareForSave($pFilename = null)
   {
      ...
      $this->saveArrayReturnType = \PHPExcel\Calculation::getArrayReturnType();
   ...
   protected function restoreStateAfterSave($fileHandle)
   {
      ...
      \PHPExcel\Calculation::setArrayReturnType($this->saveArrayReturnType);
   }
}
