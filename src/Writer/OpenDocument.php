 ...
 */
class OpenDocument extends \PHPExcel\Writer\Abs implements \PHPExcel\Writer\IWriter
{
   /**
    * Private writer parts
    *
    * @var \PHPExcel\Writer\OpenDocument\WriterPart[]
    */
   ...
   /**
    * Create a new \PHPExcel\Writer\OpenDocument
    *
    * @param \PHPExcel\PHPExcel $pPHPExcel
    */
   public function __construct(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
      $this->setPHPExcel($pPHPExcel);

      $writerPartsArray = array(
         'content'    => '\PHPExcel\Writer\OpenDocument\Content',
         'meta'       => '\PHPExcel\Writer\OpenDocument\Meta',
         'meta_inf'   => '\PHPExcel\Writer\OpenDocument\MetaInf',
         'mimetype'   => '\PHPExcel\Writer\OpenDocument\Mimetype',
         'settings'   => '\PHPExcel\Writer\OpenDocument\Settings',
         'styles'     => '\PHPExcel\Writer\OpenDocument\Styles',
         'thumbnails' => '\PHPExcel\Writer\OpenDocument\Thumbnails'
      );
    ...
    * Set PHPExcel object
    *
    * @param \PHPExcel\PHPExcel  $pPHPExcel  PHPExcel object
    * @throws \PHPExcel\Writer\Exception
    * @return \PHPExcel\Writer\Excel2007
    */
   public function setPHPExcel(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
