...
/**
 * \PHPExcel\Writer\Excel2007\Workbook
 *
 ...
 */
class Workbook extends \PHPExcel\Writer\Excel2007\WriterPart
{
   /**
    ...
    */
   public function writeWorkbook(\PHPExcel\PHPExcel $pPHPExcel = null, $recalcRequired = false)
   {
      // Create XML writer
      $objWriter = null;
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   private function writeBookViews(\PHPExcel\Shared\XMLWriter $objWriter = null, \PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // bookViews
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   private function writeWorkbookProtection(\PHPExcel\Shared\XMLWriter $objWriter = null, \PHPExcel\PHPExcel $pPHPExcel = null)
   {
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   private function writeSheets(\PHPExcel\Shared\XMLWriter $objWriter = null, \PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // Write sheets
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   private function writeDefinedNames(\PHPExcel\Shared\XMLWriter $objWriter = null, \PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // Write defined names
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   private function writeNamedRanges(\PHPExcel\Shared\XMLWriter $objWriter = null, \PHPExcel\PHPExcel $pPHPExcel)
   {
      // Loop named ranges
