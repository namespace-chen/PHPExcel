...
/**
 * \PHPExcel\Writer\Excel2007\ContentTypes
 *
 ...
 */
class ContentTypes extends \PHPExcel\Writer\Excel2007\WriterPart
{
   /**
    ...
    */
   public function writeContentTypes(\PHPExcel\PHPExcel $pPHPExcel = null, $includeCharts = false)
   {
      // Create XML writer
      $objWriter = null;
