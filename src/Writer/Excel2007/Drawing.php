...
/**
 * \PHPExcel\Writer\Excel2007\Drawing
 *
 ...
 */
class Drawing extends \PHPExcel\Writer\Excel2007\WriterPart
{
   /**
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function writeChart(\PHPExcel\Shared\XMLWriter $objWriter = null, \PHPExcel\Chart $pChart = null, $pRelationId = -1)
   {
...
*/
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function allDrawings(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // Get an array of all drawings
      $aDrawings    = array();
