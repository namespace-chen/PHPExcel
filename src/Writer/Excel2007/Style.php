...
/**
 * \PHPExcel\Writer\Excel2007\Style
 *
 ...
 */
class Style extends \PHPExcel\Writer\Excel2007\WriterPart
{
   /**
    ...
    */
   public function writeStyles(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // Create XML writer
      $objWriter = null;
   ...
   private function writeFill(\PHPExcel\Shared\XMLWriter $objWriter = null, \PHPExcel\Style\Fill $pFill = null)
   {
      ...
      if (
         $pFill->getFillType() === \PHPExcel\Style\Fill::FILL_GRADIENT_LINEAR ||
    ...
    * @param \PHPExcel\PHPExcel                            $pPHPExcel        Workbook
    * @throws     \PHPExcel\Writer\Exception
    */
   private function writeCellStyleXf(\PHPExcel\Shared\XMLWriter $objWriter = null, \PHPExcel\Style $pStyle = null, \PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // xf
      $objWriter->startElement('xf');
      $objWriter->writeAttribute('xfId', 0);
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function allStyles(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function allConditionalStyles(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // Get an array of all styles
      $aStyles = array();
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function allFills(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function allFonts(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function allBorders(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function allNumberFormats(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
