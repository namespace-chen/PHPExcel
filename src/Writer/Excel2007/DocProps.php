...
/**
 * \PHPExcel\Writer\Excel2007\DocProps
 *
 ...
 */
class DocProps extends \PHPExcel\Writer\Excel2007\WriterPart
{
   /**
    ...
    */
   public function writeDocPropsApp(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // Create XML writer
      $objWriter = null;
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function writeDocPropsCore(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // Create XML writer
      $objWriter = null;
      if ($this->getParentWriter()->getUseDiskCaching()) {
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function writeDocPropsCustom(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
