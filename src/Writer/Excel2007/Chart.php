...
/**
 * \PHPExcel\Writer\Excel2007\Chart
 *
 ...
 */
class Chart extends \PHPExcel\Writer\Excel2007\WriterPart
{
    ...
    * @throws  \PHPExcel\Writer\Exception
    */
   private function writeTitle(\PHPExcel\Chart\Title $title = null, $objWriter)
   {
      if (is_null($title)) {
         return;
      }
    ...
    * @throws  \PHPExcel\Writer\Exception
    */
   private function writeLegend(\PHPExcel\Chart\Legend $legend = null, $objWriter)
   {
      if (is_null($legend)) {
         return;
      }
    ...
    * @param  \PHPExcel\Chart\Axis $xAxis
    * @param  \PHPExcel\Chart\Axis $yAxis
    * @param  \PHPExcel\Shared\XMLWriter $objWriter XML Writer
    *
    * @throws  \PHPExcel\Writer\Exception
    */
   private function writePlotArea(\PHPExcel\Chart\PlotArea $plotArea, \PHPExcel\Chart\Title $xAxisLabel = null, \PHPExcel\Chart\Title $yAxisLabel = null, $objWriter, \PHPExcel\Worksheet $pSheet, \PHPExcel\Chart\Axis $xAxis, \PHPExcel\Chart\Axis $yAxis, \PHPExcel\Chart\GridLines $majorGridlines, \PHPExcel\Chart\GridLines $minorGridlines)
   {
      if (is_null($plotArea)) {
         return;
      }
      ...
      foreach ($chartTypes as $chartType) {
         ...
         for ($i = 0; $i < $groupCount; ++$i) {
            ...
            if ($groupType == $chartType) {
               ...
               if ($groupType === \PHPExcel\Chart\DataSeries::TYPE_RADARCHART) {
                  $objWriter->startElement('c:radarStyle');
                  $objWriter->writeAttribute('val', $plotStyle);
                  $objWriter->endElement();
               } elseif ($groupType === \PHPExcel\Chart\DataSeries::TYPE_SCATTERCHART) {
         ...
         if ($chartType === \PHPExcel\Chart\DataSeries::TYPE_LINECHART) {
            //    Line only, Line3D can't be smoothed

            $objWriter->startElement('c:smooth');
            $objWriter->writeAttribute('val', (int) $plotGroup->getSmoothLine());
            $objWriter->endElement();
         } elseif (($chartType === \PHPExcel\Chart\DataSeries::TYPE_BARCHART) || ($chartType === \PHPExcel\Chart\DataSeries::TYPE_BARCHART_3D)) {
         ...
         } elseif ($chartType === \PHPExcel\Chart\DataSeries::TYPE_BUBBLECHART) {
            ...
            $objWriter->writeAttribute('val', 0);
            $objWriter->endElement();
         } elseif ($chartType === \PHPExcel\Chart\DataSeries::TYPE_STOCKCHART) {
         ...
         if (($chartType !== \PHPExcel\Chart\DataSeries::TYPE_PIECHART) && ($chartType !== \PHPExcel\Chart\DataSeries::TYPE_PIECHART_3D) && ($chartType !== \PHPExcel\Chart\DataSeries::TYPE_DONUTCHART)) {
            ...
            if ($chartType === \PHPExcel\Chart\DataSeries::TYPE_DONUTCHART) {
      ...
      if (($chartType !== \PHPExcel\Chart\DataSeries::TYPE_PIECHART) && ($chartType !== \PHPExcel\Chart\DataSeries::TYPE_PIECHART_3D) && ($chartType !== \PHPExcel\Chart\DataSeries::TYPE_DONUTCHART)) {
         if ($chartType === \PHPExcel\Chart\DataSeries::TYPE_BUBBLECHART) {
    ...
    * @throws  \PHPExcel\Writer\Exception
    */
   private function writeCategoryAxis($objWriter, \PHPExcel\Chart\PlotArea $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis)
   {
    ...
    * @throws  \PHPExcel\Writer\Exception
    */
   private function writeValueAxis($objWriter, \PHPExcel\Chart\PlotArea $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines)
   {
      ...
      if (!is_null($yAxisLabel)) {
         ...
         if ($groupType !== \PHPExcel\Chart\DataSeries::TYPE_BUBBLECHART) {
    ...
    *
    * @param  \PHPExcel\Chart\DataSeries $plotGroup
   ...
   private function writePlotGroup($plotGroup, $groupType, $objWriter, &$catIsMultiLevelSeries, &$valIsMultiLevelSeries, &$plotGroupingType, \PHPExcel\Worksheet $pSheet)
   {
      ...
      if (($groupType == \PHPExcel\Chart\DataSeries::TYPE_BARCHART) || ($groupType == \PHPExcel\Chart\DataSeries::TYPE_BARCHART_3D)) {
      ...
      if (($groupType !== \PHPExcel\Chart\DataSeries::TYPE_RADARCHART) && ($groupType !== \PHPExcel\Chart\DataSeries::TYPE_STOCKCHART)) {
         if ($groupType !== \PHPExcel\Chart\DataSeries::TYPE_LINECHART) {
            if (($groupType == \PHPExcel\Chart\DataSeries::TYPE_PIECHART) || ($groupType == \PHPExcel\Chart\DataSeries::TYPE_PIECHART_3D) || ($groupType == \PHPExcel\Chart\DataSeries::TYPE_DONUTCHART) || ($plotSeriesCount > 1)) {
      ...
      foreach ($plotSeriesOrder as $plotSeriesIdx => $plotSeriesRef) {
         ...
         if (($groupType == \PHPExcel\Chart\DataSeries::TYPE_PIECHART) || ($groupType == \PHPExcel\Chart\DataSeries::TYPE_PIECHART_3D) || ($groupType == \PHPExcel\Chart\DataSeries::TYPE_DONUTCHART)) {
         ...
         if (($groupType == \PHPExcel\Chart\DataSeries::TYPE_LINECHART) || ($groupType == \PHPExcel\Chart\DataSeries::TYPE_STOCKCHART)) {
            $objWriter->startElement('c:spPr');
            $objWriter->startElement('a:ln');
            $objWriter->writeAttribute('w', 12700);
            if ($groupType == \PHPExcel\Chart\DataSeries::TYPE_STOCKCHART) {
         ...
         if (($groupType === \PHPExcel\Chart\DataSeries::TYPE_BARCHART) || ($groupType === \PHPExcel\Chart\DataSeries::TYPE_BARCHART_3D) || ($groupType === \PHPExcel\Chart\DataSeries::TYPE_BUBBLECHART)) {
         ...
         if ($plotSeriesCategory && ($plotSeriesCategory->getPointCount() > 0)) {
            ...
            if (($groupType === \PHPExcel\Chart\DataSeries::TYPE_BUBBLECHART) || ($groupType === \PHPExcel\Chart\DataSeries::TYPE_SCATTERCHART)) {
    ...
    *
    * @param  \PHPExcel\Chart\DataSeriesValues $plotSeriesLabel
    * @param  \PHPExcel\Shared\XMLWriter $objWriter XML Writer
    *
    * @throws  \PHPExcel\Writer\Exception
    */
    ...
    *
    * @param  \PHPExcel\Chart\DataSeriesValues $plotSeriesValues
    * @param  \PHPExcel\Shared\XMLWriter $objWriter XML Writer
    * @param  string $groupType Type of plot for dataseries
    ...
    * Write Layout
    *
    * @param  \PHPExcel\Chart\Layout $layout
    * @param  \PHPExcel\Shared\XMLWriter $objWriter XML Writer
    *
    * @throws  \PHPExcel\Writer\Exception
    */
   private function writeLayout(\PHPExcel\Chart\Layout $layout = null, $objWriter)
   {
