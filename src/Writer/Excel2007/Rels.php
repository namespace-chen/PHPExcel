...
/**
 * \PHPExcel\Writer\Excel2007\Rels
 *
 ...
 */
class Rels extends \PHPExcel\Writer\Excel2007\WriterPart
{
   /**
    ...
    */
   public function writeRelationships(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // Create XML writer
      $objWriter = null;
    ...
    * @throws     \PHPExcel\Writer\Exception
    */
   public function writeWorkbookRelationships(\PHPExcel\PHPExcel $pPHPExcel = null)
   {
      // Create XML writer
      $objWriter = null;
      if ($this->getParentWriter()->getUseDiskCaching()) {
   ...
   public function writeDrawingRelationships(\PHPExcel\Worksheet $pWorksheet = null, &$chartRef, $includeCharts = false)
   {
      ...
      while ($iterator->valid()) {
         if (
            $iterator->current() instanceof \PHPExcel\Worksheet\Drawing
