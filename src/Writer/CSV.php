 ...
 */
class CSV extends \PHPExcel\Writer\Abs implements \PHPExcel\Writer\IWriter
{
   /**
    * PHPExcel object
    *
   ...
   /**
    * Create a new \PHPExcel\Writer\CSV
    *
   ...
   private function writeLine($pFileHandle = null, $pValues = null)
   {
      if (is_array($pValues)) {
         ...
         throw new \PHPExcel\Writer\Exception("Invalid data row passed to CSV writer.");
      }
   }
}
