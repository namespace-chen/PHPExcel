...
// */
class Workbook extends \PHPExcel\Writer\Excel5\BIFFwriter
{
   /**
    * Formula parser
    *
    ...
    * Class constructor
    *
    * @param \PHPExcel\PHPExcel    $phpExcel        The Workbook
    ...
    */
   public function __construct(\PHPExcel\PHPExcel $phpExcel = null, &$str_total, &$str_unique, &$str_table, &$colors, $parser)
   {
   ...
   {
      $xfWriter = new \PHPExcel\Writer\Excel5\Xf($style);
