...
class PHPExcel
{
   ...
   public function __construct()
   {
      ...
      $this->calculationEngine = new \PHPExcel\Calculation($this);

      // Initialise worksheet collection and add one worksheet
      $this->workSheetCollection = array();
      $this->workSheetCollection[] = new \PHPExcel\Worksheet($this);
      $this->activeSheetIndex = 0;

      // Create document properties
      $this->properties = new \PHPExcel\DocumentProperties();

      // Create document security
      $this->security = new \PHPExcel\DocumentSecurity();

      // Set named ranges
      $this->namedRanges = array();

      // Create the cellXf supervisor
      $this->cellXfSupervisor = new \PHPExcel\Style(true);
      $this->cellXfSupervisor->bindParent($this);

      // Create the default style
      $this->addCellXf(new \PHPExcel\Style);
      $this->addCellStyleXf(new \PHPExcel\Style);
   }
    ...
    */
   public function setProperties(\PHPExcel\DocumentProperties $pValue)
   {
    ...
    */
   public function setSecurity(\PHPExcel\DocumentSecurity $pValue)
   {
   ...
   {
      $newSheet = new \PHPExcel\Worksheet($this);
    ...
    * @throws \PHPExcel\Exception
    */
   public function addSheet(\PHPExcel\Worksheet $pSheet, $iSheetIndex = null)
   {
    ...
    * @throws \PHPExcel\Exception
    */
   public function getIndex(\PHPExcel\Worksheet $pSheet)
   {
      ...
      throw new \PHPExcel\Exception("Sheet does not exist.");
   }
   ...
   {
      if (($worksheet = $this->getSheetByName($pValue)) instanceof \PHPExcel\Worksheet) {
         $this->setActiveSheetIndex($this->getIndex($worksheet));
         return $worksheet;
      }

      throw new \PHPExcel\Exception('Workbook does not contain sheet:' . $pValue);
   }
    ...
    * @return \PHPExcel\Worksheet
    */
   public function addExternalSheet(\PHPExcel\Worksheet $pSheet, $iSheetIndex = null)
   {
      if ($this->sheetNameExists($pSheet->getTitle())) {
         throw new \PHPExcel\Exception("Workbook already contains a worksheet named '{$pSheet->getTitle()}'. Rename the external sheet first.");
      }
    ...
    * @return boolean
    */
   public function addNamedRange(\PHPExcel\NamedRange $namedRange)
   {
    ...
    */
   public function getNamedRange($namedRange, \PHPExcel\Worksheet $pSheet = null)
   {
      $returnValue = null;
    ...
    * @return PHPExcel
    */
   public function removeNamedRange($namedRange, \PHPExcel\Worksheet $pSheet = null)
   {
      if ($pSheet === null) {
         if (isset($this->namedRanges[$namedRange])) {
   ...
   {
      return new \PHPExcel\WorksheetIterator($this);
   }
    ...
    *
    * @param  string $pValue
    * @return \PHPExcel\Style|boolean False if no match found
    */
   ...
   public function getDefaultStyle()
   {
      ...
      throw new \PHPExcel\Exception('No default style found for this workbook');
   }
    ...
    */
   public function addCellXf(\PHPExcel\Style $style)
   {
   ...
   public function removeCellXfByIndex($pIndex = 0)
   {
      if ($pIndex > count($this->cellXfCollection) - 1) {
         throw new \PHPExcel\Exception("CellXf index is out of bounds.");
      } else {
    ...
    */
   public function addCellStyleXf(\PHPExcel\Style $pStyle)
   {
   ...
   public function removeCellStyleXfByIndex($pIndex = 0)
   {
      if ($pIndex > count($this->cellStyleXfCollection) - 1) {
         throw new \PHPExcel\Exception("CellStyleXf index is out of bounds.");
      } else {
   ...
   public function garbageCollect()
   {
      ...
      if (empty($this->cellXfCollection)) {
         $this->cellXfCollection[] = new \PHPExcel\Style();
      }
