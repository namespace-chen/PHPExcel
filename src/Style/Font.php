 ...
 */
class Font extends \PHPExcel\Style\Supervisor implements \PHPExcel\IComparable
{
   /* Underline types */
   ...
   /**
    * Create a new \PHPExcel\Style\Font
    *
   ...
   public function __construct($isSupervisor = false, $isConditional = false)
   {
      ...
      if ($isConditional) {
         ...
         $this->color = new \PHPExcel\Style\Color(\PHPExcel\Style\Color::COLOR_BLACK, $isSupervisor, $isConditional);
      } else {
