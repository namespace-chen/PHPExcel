 ...
 */
class Border extends \PHPExcel\Style\Supervisor implements \PHPExcel\IComparable
{
   /* Border style */
    ...
    * @var string
    */
   protected $borderStyle = \PHPExcel\Style\Border::BORDER_NONE;
   ...
   /**
    * Create a new \PHPExcel\Style\Border
    *
   ...
   public function __construct($isSupervisor = false, $isConditional = false)
   {
      ...
      // Initialise values
      $this->color    = new \PHPExcel\Style\Color(\PHPExcel\Style\Color::COLOR_BLACK, $isSupervisor);
    ...
    *
    * @param \PHPExcel\Style\Borders $parent
    ...
    *                            When passing a boolean, FALSE equates \PHPExcel\Style\Border::BORDER_NONE
    *                                and TRUE to \PHPExcel\Style\Border::BORDER_MEDIUM
    * @return \PHPExcel\Style\Border
    */
   public function setBorderStyle($pValue = \PHPExcel\Style\Border::BORDER_NONE)
   {

      if (empty($pValue)) {
         $pValue = \PHPExcel\Style\Border::BORDER_NONE;
      } elseif (is_bool($pValue) && $pValue) {
         $pValue = \PHPExcel\Style\Border::BORDER_MEDIUM;
      }
      if ($this->isSupervisor) {
