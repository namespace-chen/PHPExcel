...
class Conditional implements \PHPExcel\IComparable
{
   ...
   /**
    * Create a new \PHPExcel\Style\Conditional
    */
   public function __construct()
   {
      // Initialise values
      $this->conditionType = \PHPExcel\Style\Conditional::CONDITION_NONE;
      $this->operatorType  = \PHPExcel\Style\Conditional::OPERATOR_NONE;
      $this->text          = null;
    ...
    * Set Condition type
    *
    * @param string $pValue    \PHPExcel\Style\Conditional condition type
    * @return \PHPExcel\Style\Conditional
    */
   public function setConditionType($pValue = \PHPExcel\Style\Conditional::CONDITION_NONE)
   {
    ...
    * Set Operator type
    *
    * @param string $pValue    \PHPExcel\Style\Conditional operator type
    * @return \PHPExcel\Style\Conditional
    */
   public function setOperatorType($pValue = \PHPExcel\Style\Conditional::OPERATOR_NONE)
   {
