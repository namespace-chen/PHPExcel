 ...
 */
class Alignment extends \PHPExcel\Style\Supervisor implements \PHPExcel\IComparable
{
    ...
    * @var string
    */
   protected $horizontal = \PHPExcel\Style\Alignment::HORIZONTAL_GENERAL;
    ...
    * @var string
    */
   protected $vertical = \PHPExcel\Style\Alignment::VERTICAL_BOTTOM;
   ...
   /**
    * Create a new \PHPExcel\Style\Alignment
    *
    ...
    * @return \PHPExcel\Style\Alignment
    */
   public function setHorizontal($pValue = \PHPExcel\Style\Alignment::HORIZONTAL_GENERAL)
   {
      if ($pValue == '') {
         $pValue = \PHPExcel\Style\Alignment::HORIZONTAL_GENERAL;
      }
    ...
    * @return \PHPExcel\Style\Alignment
    */
   public function setVertical($pValue = \PHPExcel\Style\Alignment::VERTICAL_BOTTOM)
   {
      if ($pValue == '') {
         $pValue = \PHPExcel\Style\Alignment::VERTICAL_BOTTOM;
      }
