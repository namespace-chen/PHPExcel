 ...
 */
class Fill extends \PHPExcel\Style\Supervisor implements \PHPExcel\IComparable
{
   /* Fill types */
    ...
    * @var string
    */
   protected $fillType = \PHPExcel\Style\Fill::FILL_NONE;
   ...
   /**
    * Create a new \PHPExcel\Style\Fill
    *
   ...
   public function __construct($isSupervisor = false, $isConditional = false)
   {
      ...
      $this->startColor = new \PHPExcel\Style\Color(\PHPExcel\Style\Color::COLOR_WHITE, $isSupervisor, $isConditional);
      $this->endColor = new \PHPExcel\Style\Color(\PHPExcel\Style\Color::COLOR_BLACK, $isSupervisor, $isConditional);
    ...
    * Set Fill Type
    *
    * @param string $pValue    \PHPExcel\Style\Fill fill type
    * @return \PHPExcel\Style\Fill
    */
   public function setFillType($pValue = \PHPExcel\Style\Fill::FILL_NONE)
   {
      if ($this->isSupervisor) {
    ...
    * @return \PHPExcel\Style\Fill
    */
   public function setStartColor(\PHPExcel\Style\Color $pValue = null)
   {
    ...
    * @return \PHPExcel\Style\Fill
    */
   public function setEndColor(\PHPExcel\Style\Color $pValue = null)
   {
      // make sure parameter is a real color and not a supervisor
      $color = $pValue->getIsSupervisor() ? $pValue->getSharedComponent() : $pValue;
