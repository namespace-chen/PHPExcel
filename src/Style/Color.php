 ...
 */
class Color extends \PHPExcel\Style\Supervisor implements \PHPExcel\IComparable
{
   /* Colors */
   ...
   /**
    * Create a new \PHPExcel\Style\Color
    *
    ...
    *                                        its ramifications are
    */
   public function __construct($pARGB = \PHPExcel\Style\Color::COLOR_BLACK, $isSupervisor = false, $isConditional = false)
   {
      //    Supervisor?
    ...
    * @return \PHPExcel\Style\Color
    */
   public function setARGB($pValue = \PHPExcel\Style\Color::COLOR_BLACK)
   {
      if ($pValue == '') {
         $pValue = \PHPExcel\Style\Color::COLOR_BLACK;
      }
      if ($this->isSupervisor) {
   ...
   public static function indexedColor($pIndex, $background = false)
   {
      ...
      if (array_key_exists($pIndex, self::$indexedColors)) {
         return new \PHPExcel\Style\Color(self::$indexedColors[$pIndex]);
      }

      if ($background) {
         return new \PHPExcel\Style\Color(self::COLOR_WHITE);
      }
      return new \PHPExcel\Style\Color(self::COLOR_BLACK);
   }
