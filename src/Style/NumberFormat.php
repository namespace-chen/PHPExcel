 ...
 */
class NumberFormat extends \PHPExcel\Style\Supervisor implements \PHPExcel\IComparable
{
   /* Pre-defined formats */
    ...
    * @var string
    */
   protected $formatCode = \PHPExcel\Style\NumberFormat::FORMAT_GENERAL;
   ...
   /**
    * Create a new \PHPExcel\Style\NumberFormat
    *
    ...
    * @return \PHPExcel\Style\NumberFormat
    */
   public function setFormatCode($pValue = \PHPExcel\Style\NumberFormat::FORMAT_GENERAL)
   {
      if ($pValue == '') {
         $pValue = \PHPExcel\Style\NumberFormat::FORMAT_GENERAL;
      }
      if ($this->isSupervisor) {
   ...
   private static function fillBuiltInFormatCodes()
   {
      ...
      if (is_null(self::$builtInFormats)) {
         ...
         // General
         self::$builtInFormats[0] = \PHPExcel\Style\NumberFormat::FORMAT_GENERAL;
    ...
    */
   public static function toFormattedString($value = '0', $format = \PHPExcel\Style\NumberFormat::FORMAT_GENERAL, $callBack = null)
   {
      ...
      if (($format === \PHPExcel\Style\NumberFormat::FORMAT_GENERAL) || ($format === \PHPExcel\Style\NumberFormat::FORMAT_TEXT)) {
         return $value;
      }
