...
class DateTime
{
   ...
   public static function getDateValue($dateValue)
   {
      if (!is_numeric($dateValue)) {
         ...
         if ((is_object($dateValue)) && ($dateValue instanceof DateTime)) {
            ...
            $saveReturnDateType = \PHPExcel\Calculation\Funcs::getReturnDateType();
            \PHPExcel\Calculation\Funcs::setReturnDateType(\PHPExcel\Calculation\Funcs::RETURNDATE_EXCEL);
            $dateValue = self::DATEVALUE($dateValue);
            \PHPExcel\Calculation\Funcs::setReturnDateType($saveReturnDateType);
         }
      }
      return $dateValue;
   }
   ...
   public static function DATETIMENOW()
   {
      ...
      $retValue = false;
      switch (\PHPExcel\Calculation\Funcs::getReturnDateType()) {
         case \PHPExcel\Calculation\Funcs::RETURNDATE_EXCEL:
            $retValue = (float) \PHPExcel\Shared\Date::PHPToExcel(time());
            break;
         case \PHPExcel\Calculation\Funcs::RETURNDATE_PHP_NUMERIC:
            $retValue = (int) time();
            break;
         case \PHPExcel\Calculation\Funcs::RETURNDATE_PHP_OBJECT:
   ...
   public static function DATENOW()
   {
      ...
      switch (\PHPExcel\Calculation\Funcs::getReturnDateType()) {
         case \PHPExcel\Calculation\Funcs::RETURNDATE_EXCEL:
            ...
            break;
         case \PHPExcel\Calculation\Funcs::RETURNDATE_PHP_NUMERIC:
            $retValue = (int) \PHPExcel\Shared\Date::ExcelToPHP($excelDateTime);
            break;
         case \PHPExcel\Calculation\Funcs::RETURNDATE_PHP_OBJECT:
   ...
   {
      $year  = \PHPExcel\Calculation\Funcs::flattenSingleValue($year);
      $month = \PHPExcel\Calculation\Funcs::flattenSingleValue($month);
      $day   = \PHPExcel\Calculation\Funcs::flattenSingleValue($day);
   ...
   {
      $hour = \PHPExcel\Calculation\Funcs::flattenSingleValue($hour);
      $minute = \PHPExcel\Calculation\Funcs::flattenSingleValue($minute);
      $second = \PHPExcel\Calculation\Funcs::flattenSingleValue($second);
      ...
      switch (\PHPExcel\Calculation\Funcs::getReturnDateType()) {
         ...
         case \PHPExcel\Calculation\Funcs::RETURNDATE_PHP_NUMERIC:
            return (int) \PHPExcel\Shared\Date::ExcelToPHP(\PHPExcel\Shared\Date::FormattedPHPToExcel(1970, 1, 1, $hour, $minute, $second));    // -2147468400; //    -2147472000 + 3600
         case \PHPExcel\Calculation\Funcs::RETURNDATE_PHP_OBJECT:
            $dayAdjust = 0;
            if ($hour < 0) {
   ...
   {
      $dateValue = trim(\PHPExcel\Calculation\Funcs::flattenSingleValue($dateValue), '"');
   ...
   {
      $timeValue = trim(\PHPExcel\Calculation\Funcs::flattenSingleValue($timeValue), '"');
      ...
      if (($PHPDateArray !== false) && ($PHPDateArray['error_count'] == 0)) {
         ...
         switch (\PHPExcel\Calculation\Funcs::getReturnDateType()) {
            case \PHPExcel\Calculation\Funcs::RETURNDATE_EXCEL:
               return (float) $excelDateValue;
            case \PHPExcel\Calculation\Funcs::RETURNDATE_PHP_NUMERIC:
               return (int) $phpDateValue = \PHPExcel\Shared\Date::ExcelToPHP($excelDateValue + 25569) - 3600;
            case \PHPExcel\Calculation\Funcs::RETURNDATE_PHP_OBJECT:
   ...
   {
      $startDate = \PHPExcel\Calculation\Funcs::flattenSingleValue($startDate);
      $endDate   = \PHPExcel\Calculation\Funcs::flattenSingleValue($endDate);
      $unit      = strtoupper(\PHPExcel\Calculation\Funcs::flattenSingleValue($unit));
      ...
      $retVal = \PHPExcel\Calculation\Funcs::NaN();
      switch ($unit) {
         case 'D':
   ...
   public static function YEARFRAC($startDate = 0, $endDate = 0, $method = 0)
   {
      $startDate    = \PHPExcel\Calculation\Funcs::flattenSingleValue($startDate);
      $endDate    = \PHPExcel\Calculation\Funcs::flattenSingleValue($endDate);
      $method        = \PHPExcel\Calculation\Funcs::flattenSingleValue($method);
   ...
   public static function NETWORKDAYS($startDate, $endDate)
   {
      ...
      $dateArgs = \PHPExcel\Calculation\Funcs::flattenArray(func_get_args());
   ...
   public static function WORKDAY($startDate, $endDays)
   {
      ...
      $startDate    = \PHPExcel\Calculation\Funcs::flattenSingleValue($startDate);
      $endDays    = \PHPExcel\Calculation\Funcs::flattenSingleValue($endDays);
   ...
   {
      $dateValue    = \PHPExcel\Calculation\Funcs::flattenSingleValue($dateValue);
   ...
   {
      $dateValue    = \PHPExcel\Calculation\Funcs::flattenSingleValue($dateValue);
      $style        = \PHPExcel\Calculation\Funcs::flattenSingleValue($style);
      ...
      if (\PHPExcel\Calculation\Funcs::getCompatibilityMode() == \PHPExcel\Calculation\Funcs::COMPATIBILITY_EXCEL) {
   ...
   {
      $timeValue    = \PHPExcel\Calculation\Funcs::flattenSingleValue($timeValue);
   ...
   {
      $timeValue = $timeTester    = \PHPExcel\Calculation\Funcs::flattenSingleValue($timeValue);
   ...
   {
      $dateValue            = \PHPExcel\Calculation\Funcs::flattenSingleValue($dateValue);
      $adjustmentMonths    = \PHPExcel\Calculation\Funcs::flattenSingleValue($adjustmentMonths);
