...
/**
 * \PHPExcel\Calculation\Engineering
 *
...
class Engineering
{
   ...
   {
      $x    = (is_null($x))    ? 0.0 :    \PHPExcel\Calculation\Funcs::flattenSingleValue($x);
      $ord    = (is_null($ord))    ? 0.0 :    \PHPExcel\Calculation\Funcs::flattenSingleValue($ord);
      ...
      if ((is_numeric($x)) && (is_numeric($ord))) {
         ...
         if (abs($x) <= 30) {
            $fResult = $fTerm = pow($x / 2, $ord) / \PHPExcel\Calculation\MathTrig::FACT($ord);
            $ordK = 1;
            $fSqrX = ($x * $x) / 4;
            do {
               $fTerm *= $fSqrX;
         ...
         return (is_nan($fResult)) ? \PHPExcel\Calculation\Funcs::NaN() : $fResult;
      }
   ...
   public static function BESSELK($x, $ord)
   {
      ...
      if ((is_numeric($x)) && (is_numeric($ord))) {
         ...
         return (is_nan($fBk)) ? \PHPExcel\Calculation\Funcs::NaN() : $fBk;
      }
      return \PHPExcel\Calculation\Funcs::VALUE();
   }
   ...
   public static function BESSELY($x, $ord)
   {
      ...
      if ((is_numeric($x)) && (is_numeric($ord))) {
         ...
         return (is_nan($fBy)) ? \PHPExcel\Calculation\Funcs::NaN() : $fBy;
      }
      return \PHPExcel\Calculation\Funcs::VALUE();
   }
   ...
   {
      $x    = \PHPExcel\Calculation\Funcs::flattenSingleValue($x);
      $places    = \PHPExcel\Calculation\Funcs::flattenSingleValue($places);
   ...
   {
      $realNumber = (is_null($realNumber)) ? 0.0 : \PHPExcel\Calculation\Funcs::flattenSingleValue($realNumber);
      $imaginary  = (is_null($imaginary))  ? 0.0 : \PHPExcel\Calculation\Funcs::flattenSingleValue($imaginary);
      $suffix     = (is_null($suffix))     ? 'i' : \PHPExcel\Calculation\Funcs::flattenSingleValue($suffix);
   ...
   {
      $complexNumber    = \PHPExcel\Calculation\Funcs::flattenSingleValue($complexNumber);
   ...
   {
      $complexNumber = \PHPExcel\Calculation\Funcs::flattenSingleValue($complexNumber);
      $realNumber    = \PHPExcel\Calculation\Funcs::flattenSingleValue($realNumber);
   ...
   {
      $complexDividend    = \PHPExcel\Calculation\Funcs::flattenSingleValue($complexDividend);
      $complexDivisor    = \PHPExcel\Calculation\Funcs::flattenSingleValue($complexDivisor);
   ...
   {
      $complexNumber1    = \PHPExcel\Calculation\Funcs::flattenSingleValue($complexNumber1);
      $complexNumber2    = \PHPExcel\Calculation\Funcs::flattenSingleValue($complexNumber2);
   ...
   public static function GESTEP($number, $step = 0)
   {
      ...
      $step    = \PHPExcel\Calculation\Funcs::flattenSingleValue($step);
   ...
   {
      $lower    = \PHPExcel\Calculation\Funcs::flattenSingleValue($lower);
      $upper    = \PHPExcel\Calculation\Funcs::flattenSingleValue($upper);
   ...
   public static function CONVERTUOM($value, $fromUOM, $toUOM)
   {
      ...
      $fromUOM = \PHPExcel\Calculation\Funcs::flattenSingleValue($fromUOM);
      $toUOM   = \PHPExcel\Calculation\Funcs::flattenSingleValue($toUOM);
