...
$objXLSX->getActiveSheet()->setCellValue('A1', 'Description')
                              ->setCellValue('B1', 'Amount');

$objXLSX->getActiveSheet()->setCellValue('A2', 'Paycheck received')
                              ->setCellValue('B2', 100);

$objXLSX->getActiveSheet()->setCellValue('A3', 'Cup of coffee bought')
                              ->setCellValue('B3', -1.5);

$objXLSX->getActiveSheet()->setCellValue('A4', 'Cup of coffee bought')
                              ->setCellValue('B4', -1.5);

$objXLSX->getActiveSheet()->setCellValue('A5', 'Cup of tea bought')
                              ->setCellValue('B5', -1.2);

$objXLSX->getActiveSheet()->setCellValue('A6', 'Found some money')
                              ->setCellValue('B6', 8);

$objXLSX->getActiveSheet()->setCellValue('A7', 'Total:')
                              ->setCellValue('B7', '=SUM(B2:B6)');


// Set column widths
echo date('H:i:s') , " Set column widths" , EOL;
$objXLSX->getActiveSheet()->getColumnDimension('A')->setWidth(30);
$objXLSX->getActiveSheet()->getColumnDimension('B')->setWidth(12);
...
$conditionalStyles = $objXLSX->getActiveSheet()->getStyle('B2')->getConditionalStyles();
array_push($conditionalStyles, $objConditional1);
array_push($conditionalStyles, $objConditional2);
array_push($conditionalStyles, $objConditional3);
$objXLSX->getActiveSheet()->getStyle('B2')->setConditionalStyles($conditionalStyles);


//	duplicate the conditional styles across a range of cells
echo date('H:i:s') , " Duplicate the conditional formatting across a range of cells" , EOL;
$objXLSX->getActiveSheet()->duplicateConditionalStyle(
				$objXLSX->getActiveSheet()->getStyle('B2')->getConditionalStyles(),
				'B3:B7'
			  );
...
$objXLSX->getActiveSheet()->getStyle('A1:B1')->getFont()->setBold(true);
//$objXLSX->getActiveSheet()->getStyle('B1')->getFont()->setBold(true);
$objXLSX->getActiveSheet()->getStyle('A7:B7')->getFont()->setBold(true);
//$objXLSX->getActiveSheet()->getStyle('B7')->getFont()->setBold(true);


// Set header and footer. When no different headers for odd/even are used, odd header is assumed.
echo date('H:i:s') , " Set header/footer" , EOL;
$objXLSX->getActiveSheet()->getHeaderFooter()->setOddHeader('&L&BPersonal cash register&RPrinted on &D');
