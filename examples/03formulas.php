...
$objXLSX->getActiveSheet()->setCellValue('A5', 'Sum:');
...
echo date('H:i:s') , " Sum of Range #1 is " ,
                     $objXLSX->getActiveSheet()->getCell('B5')->getCalculatedValue() , EOL;
...
echo date('H:i:s') , " Sum of Range #2 is " ,
                     $objXLSX->getActiveSheet()->getCell('C5')->getCalculatedValue() , EOL;

$objXLSX->getActiveSheet()->setCellValue('A7', 'Total of both ranges:');
$objXLSX->getActiveSheet()->setCellValue('B7', '=SUM(B5:C5)');
echo date('H:i:s') , " Sum of both Ranges is " ,
                     $objXLSX->getActiveSheet()->getCell('B7')->getCalculatedValue() , EOL;

$objXLSX->getActiveSheet()->setCellValue('A8', 'Minimum of both ranges:');
$objXLSX->getActiveSheet()->setCellValue('B8', '=MIN(B2:C4)');
echo date('H:i:s') , " Minimum value in either Range is " ,
                     $objXLSX->getActiveSheet()->getCell('B8')->getCalculatedValue() , EOL;

$objXLSX->getActiveSheet()->setCellValue('A9', 'Maximum of both ranges:');
$objXLSX->getActiveSheet()->setCellValue('B9', '=MAX(B2:C4)');
echo date('H:i:s') , " Maximum value in either Range is " ,
                     $objXLSX->getActiveSheet()->getCell('B9')->getCalculatedValue() , EOL;

$objXLSX->getActiveSheet()->setCellValue('A10', 'Average of both ranges:');
$objXLSX->getActiveSheet()->setCellValue('B10', '=AVERAGE(B2:C4)');
echo date('H:i:s') , " Average value of both Ranges is " ,
                     $objXLSX->getActiveSheet()->getCell('B10')->getCalculatedValue() , EOL;


// Rename worksheet
echo date('H:i:s') , " Rename worksheet" , EOL;
$objXLSX->getActiveSheet()->setTitle('Formulas');
