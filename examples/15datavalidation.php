...
$objXLSX->getActiveSheet()->setCellValue('A1', "Cell B3 and B5 contain data validation...")
...
$objValidation = $objXLSX->getActiveSheet()->getCell('B3')->getDataValidation();
...
$objValidation = $objXLSX->getActiveSheet()->getCell('B5')->getDataValidation();
...
$objValidation = $objXLSX->getActiveSheet()->getCell('B7')->getDataValidation();
$objValidation->setType( PHPExcel_Cell_DataValidation::TYPE_LIST );
$objValidation->setErrorStyle( PHPExcel_Cell_DataValidation::STYLE_INFORMATION );
$objValidation->setAllowBlank(false);
$objValidation->setShowInputMessage(true);
...
$objValidation = $objXLSX->getActiveSheet()->getCell('B9')->getDataValidation();
