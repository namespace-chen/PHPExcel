...
if (isset($_POST['submit'])) {
	if ($_POST['A'] == 0) {
		...
		$objXLSX->getActiveSheet()->setCellValue('A1', $_POST['A']);
		$objXLSX->getActiveSheet()->setCellValue('B1', $_POST['B']);
		$objXLSX->getActiveSheet()->setCellValue('C1', $_POST['C']);
		...
		echo $objXLSX->getActiveSheet()->getCell('B5')->getCalculatedValue().'<br />';
		echo $objXLSX->getActiveSheet()->getCell('B6')->getCalculatedValue().'<br />';
