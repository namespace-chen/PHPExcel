...
$objXLSX->getActiveSheet()->getColumnDimension('A')->setWidth(48);
$objXLSX->getActiveSheet()->getRowDimension(1)->setRowHeight(-1);
$objXLSX->getActiveSheet()->getStyle('A1')
    ->getAlignment()
    ->setWrapText(true);
...
$objXLSX->getActiveSheet()->getRowDimension(1)->setRowHeight(-1);
$objXLSX->getActiveSheet()->getStyle('A2')
    ->getAlignment()
    ->setWrapText(true);
