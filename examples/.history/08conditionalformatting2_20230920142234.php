...
$objXLSX->getActiveSheet()->getStyle('A1:A8')
    ->getNumberFormat()
    ->setFormatCode(
...
$conditionalStyles = $objXLSX->getActiveSheet()->getStyle('A1')->getConditionalStyles();
array_push($conditionalStyles, $objConditional1);
array_push($conditionalStyles, $objConditional3);
$objXLSX->getActiveSheet()->getStyle('A1')->setConditionalStyles($conditionalStyles);
...
$objXLSX->getActiveSheet()->duplicateConditionalStyle(
				$objXLSX->getActiveSheet()->getStyle('A1')->getConditionalStyles(),
				'A2:A8'
			  );
