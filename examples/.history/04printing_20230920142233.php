...
for ($i = 1; $i < 200; $i++) {
	$objXLSX->getActiveSheet()->setCellValue('A' . $i, $i);
	$objXLSX->getActiveSheet()->setCellValue('B' . $i, 'Test value');
}

// Set header and footer. When no different headers for odd/even are used, odd header is assumed.
echo date('H:i:s') , " Set header/footer" , EOL;
$objXLSX->getActiveSheet()->getHeaderFooter()->setOddHeader('&L&G&C&HPlease treat this document as confidential!');
...
$objXLSX->getActiveSheet()->getHeaderFooter()->addImage($objDrawing, PHPExcel_Worksheet_HeaderFooter::IMAGE_HEADER_LEFT);
...
$objXLSX->getActiveSheet()->setTitle('Printing');
