...
$objXLSX->getActiveSheet()->setCellValue('A1', 'Year')
...
$objXLSX->getActiveSheet()->fromArray($dataArray, NULL, 'A2');

// Set title row bold
echo date('H:i:s').' Set title row bold'.EOL;
$objXLSX->getActiveSheet()->getStyle('A1:D1')->getFont()->setBold(true);
